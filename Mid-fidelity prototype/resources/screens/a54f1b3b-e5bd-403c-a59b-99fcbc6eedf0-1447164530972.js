jQuery("#simulation")
.on("click", ".s-a54f1b3b-e5bd-403c-a59b-99fcbc6eedf0 .click", function(event, data) {
...
.on("pageload", ".s-a54f1b3b-e5bd-403c-a59b-99fcbc6eedf0 .pageload", function(event, data) {
var jEvent, jFirer, cases;
if(data === undefined) { data = event; }
jEvent = jimEvent(event);
jFirer = jEvent.getEventFirer();
