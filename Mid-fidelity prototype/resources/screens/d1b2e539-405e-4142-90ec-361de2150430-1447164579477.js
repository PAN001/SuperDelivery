jQuery("#simulation")
.on("click", ".s-d1b2e539-405e-4142-90ec-361de2150430 .click", function(event, data) {
...
.on("pageload", ".s-d1b2e539-405e-4142-90ec-361de2150430 .pageload", function(event, data) {
var jEvent, jFirer, cases;
if(data === undefined) { data = event; }
jEvent = jimEvent(event);
jFirer = jEvent.getEventFirer();
