jQuery("#simulation")
.on("click", ".s-c1581ad6-b19e-462c-aade-650296744450 .click", function(event, data) {
...
.on("pageload", ".s-c1581ad6-b19e-462c-aade-650296744450 .pageload", function(event, data) {
var jEvent, jFirer, cases;
if(data === undefined) { data = event; }
jEvent = jimEvent(event);
jFirer = jEvent.getEventFirer();
